...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-08-16 yujun  正式发布
*		V1.1	2014-06-15 yujun  完善 bsp_SetTIMOutPWM，当占空比=0和100%时，关闭定时器，GPIO配置为输出
*		V1.2	2015-05-08 yujun  解决TIM8不能输出PWM的问题。
*		V1.3	2015-07-23 yujun  初始化定时器，必须设置 TIM_TimeBaseInitStruct.TIM_RepetitionCounter = 0x0000;		
*								   TIM1 和 TIM8 必须设置。否则蜂鸣器的控制不正常。
*		V1.4	2015-07-30 yujun  增加反相引脚输出PWM函数 bsp_SetTIMOutPWM_N();
*		V1.5	2016-02-01 yujun  去掉 TIM_OC1PreloadConfig(TIMx, TIM_OCPreload_Enable);
*		V1.6	2016-02-27 yujun  解决TIM14无法中断的BUG, TIM8_TRG_COM_TIM14_IRQn
*
