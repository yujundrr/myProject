...
*	修改记录 :
*		版本号  日期        作者    说明
*       v1.0    2014-10-24 yujun  首版。将串行FLASH、TSC2046、VS1053、AD7705、ADS1256等SPI设备的配置
*									和收发数据的函数进行汇总分类。并解决不同速度的设备间的共享问题。
*		V1.1	2015-02-25 yujun  硬件SPI时，没有开启GPIOB时钟，已解决。
*		V1.2	2015-07-23 yujun  修改 bsp_SPI_Init() 函数，增加开关SPI时钟的语句。规范硬件SPI和软件SPI的宏定义.
*
...
/* 
	yujun ： 2018-10-03  SPI 遗留问题待查 (估计HAL库存在缺陷）
