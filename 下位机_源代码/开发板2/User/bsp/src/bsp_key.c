...
*		V1.1    2013-06-29 yujun  增加1个读指针，用于bsp_Idle() 函数读取系统控制组合键（截屏）
*								   增加 K1 K2 组合键 和 K2 K3 组合键，用于系统控制
*		V1.2	2016-01-25 yujun  针对P02工控板更改. 调整gpio定义方式，更加简洁
*		V1.3	2018-11-26 yujun  s_tBtn结构赋初值0
*
*	Copyright (C), 2016-2020, ************yujun*************
*
*********************************************************************************************************
*/
