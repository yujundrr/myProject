...
*	修改记录 :
*		版本号  日期       作者    说明
*		v1.0    2011-08-21 yujun  ST固件库版本 V3.5.0版本。
*					a) 取消访问寄存器的结构体，直接定义
*		V2.0    2011-10-16 yujun  增加R61509V驱动，实现图标显示函数
*		V2.1    2012-07-06 yujun  增加RA8875驱动，支持4.3寸屏
*		V2.2    2012-07-13 yujun  改进LCD_DispStr函数，支持12点阵字符;修改LCD_DrawRect,解决差一个像素问题
*		V2.3    2012-08-08 yujun  将底层芯片寄存器操作相关的函数放到单独的文件，支持RA8875
