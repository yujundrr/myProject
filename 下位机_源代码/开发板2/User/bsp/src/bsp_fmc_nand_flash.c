...
*	文件名称 : bsp_nand.c
*	版    本 : V1.3
*	说    明 : 提供NAND Flash (HY27UF081G2A， 8bit 128K字节 大页)的底层接口函数。【   原创】
*
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-02-01  yujun  正式发布
*		V1.1    2014-05-02  yujun  增加512MB型号: H27U4G8F2DTR,
...
*		V1.2	2015-07-23   yujun  增加函数 uint8_t NAND_GetBlockInfo(void); 方便LCD显示。
*		V1.3	2015-10-13   yujun  移植到STM32F429
...
/*
	...
	【硬件说明】
	   开发板配置的NAND Flahs为海力士的HY27UF081G2A,  439板子配的为 H27U4G8F2DTR
