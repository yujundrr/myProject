...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2014-11-29  yujun  正式发布
*		V1.1    2014-12-11  yujun  修改 ESP8266_WaitResponse() 函数, 实现任意字符判断。增加TCP数据发送函数.
*		V1.2    2014-12-22  yujun  增加GPIO2， GPIO0 引脚的配置。适应新版硬件。
*		V1.3	2015-07-24  yujun	
*					(1) 增加函数 uint8_t ESP8266_CreateTCPServer(void);
*					(2) 修改ESP8266_JoinAP() 增加返回值
*
*	Copyright (C), 2014-2015, ************yujun*************
*
*********************************************************************************************************
*/
