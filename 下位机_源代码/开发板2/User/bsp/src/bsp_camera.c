...
*			     STM32-V5开发板集成了3.0V LDO给OV7670供电，主板集成了24M有源晶振提供给摄像头。
*
*			  本代码参考了 guanfu_wang 提供的例子。http://mcudiy.taobao.com/
*
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-03-01 yujun  正式发布
*
*	Copyright (C), 2013-2014, ************yujun*************
*
*********************************************************************************************************
*/
...
/*
	   STM32-V7开发板摄像头接口GPIO定义： 【DCIM设备： 摄像头  和串口6, AD7606 模块不能同时使用】
	PA6/DCMI_PIXCLK
...
static void CAM_ConfigCPU(void)
{
 	/*    STM32-V7开发板采用有源晶振提供24M时钟，因此不用PA8产生时钟 */
