...
namespace PalmSens.Core.Simplified.Data
{
    public class SimpleMeasurement: IDisposable
    {
        ...
        public SimpleMeasurement(Measurement measurement)
        {
            ...
            MeasurementType = GetTypeFromMethod(Measurement.Method); //Determine the type of measurement//确定测量类型
            InitSimpleCurveCollection();
        }

        #region Properties
        /// <summary>
        /// Gets or sets the title of the measurement.获取或设置度量的标题。
        /// </summary>
        /// <value>
        /// The title.
        /// </value>
        ...
        /// <summary>
        /// Gets the type of measurement.获取度量的类型。
        /// </summary>
        /// <value>
        ...
        /// 获取存储在度量中的SimpleCurves的集合。
        /// </summary>
        /// <value>
        /// The simple curve collection.简单曲线集合。
        /// </value>
        public List<SimpleCurve> SimpleCurveCollection { get; private set; }

        /// <summary>
        /// List of the available data types in the measurement///测量中可用数据类型的列表
        /// </summary>
        ...
        /// <summary>
        /// Gets the channel that the measurement was measured on.///获取进行测量的通道。
        /// </summary>
        /// <value>
        /// The channel.
        /// </value>
        ...
        /// <summary>
        /// Add a new SimpleCurve to the measurement with the specified X and Y-Axis data types.向具有指定的X轴和y轴数据类型的度量中添加一个新的SimpleCurve。
        /// </summary>
    ...
    {
        LinearSweepVoltammetry = 0,  //lsv
        CyclicVoltammetry = 1, //cv
        ACVoltammetry = 2,
